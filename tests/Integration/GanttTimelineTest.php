...
/**
 * Integration tests for Gantt timeline interactions
 */
final class GanttTimelineTest extends TestCase
{
    ...
    public function test_task_with_start_and_due_date_appears_in_timeline(): void
    {
        // Create task with both dates
        $task = $this->repo->create(
            title: 'Timeline Task',
            completed: false,
            description: 'Task for timeline',
        ...
        $this->assertEquals('Timeline Task', $task['title']);
    }
    ...
    public function test_priority_colors_on_timeline_bars(): void
    {
    ...
    public function test_overlapping_tasks_on_timeline(): void
    {
